...
export const Section1 = () => {
    ...
    <p class="welcome_text">${titleNavigition}</p>
    </div>
    <div class="wellcome_first_text">
    <p class="wellcome_first_subtitle">${subtitleNevigation}</p>
    </div>
    ...
    <p class="welcome_text">${welcomeTextNavigation}</p>
    </div>
    <div class="wellcome_first_text">
    <p class="wellcome_second_subtitle">${secondSubTitleNavigation}</p>
    </div>
    ...
    <div class="wellcome_first_text">
    <p class="wellcome_third_subtitle">${thirdSubTitleNavigation}</p>
    </div>
